...
| 维度分类 | 风控目的 | 特征名称 | 物理含义 | log1p / 归一化 |
|---|---|---|---|---|
| **资金规模与体量** | 捕捉「大体量+小笔均」的拆单洗钱模式 | `total_amount_paid` | 总转出金额 | √ |
| **资金规模与体量** | 捕捉「大体量+小笔均」的拆单洗钱模式 | `total_amount_received` | 总转入金额 | √ |
| **资金规模与体量** | 捕捉「大体量+小笔均」的拆单洗钱模式 | `avg_amount_paid` | 笔均转出金额 | √ |
| **资金规模与体量** | 捕捉「大体量+小笔均」的拆单洗钱模式 | `avg_amount_received` | 笔均转入金额 | √ |
| **资金流动与留存** | 识别过路中转、高复杂度洗钱 | `net_flow_ratio` | 资金净流转率 | √ |
| **资金流动与留存** | 识别过路中转、高复杂度洗钱 | `unique_currency_count` | 涉及货币种类总数 | √ |
